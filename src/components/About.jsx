          ...
          <Container className='About'  id='about'>
            <Row className='text-left about-text'>
              ...
              <h1>Hello! Nice to meet you.</h1>
                <p>I am an avid software developer with passion for solving problems. I help clients to translate complex problem statements into easy-to-understand solutions. I believe in modern aesthetics and minimalist design principles.
                   <span className='d-none d-sm-none d-md-block'><br/> I am naturally inquisitive and strive to keep myself updated with the latest trends in technologies. When I am not developing apps, you’ll find me shredding my guitar or out in the field playing football.</span>
                </p>
              </Col>
            </Row>
            <Row>
